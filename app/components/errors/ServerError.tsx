      ...
      <div className="container relative mx-auto px-4 py-10 md:py-20">
        <div className={`flex flex-col items-center text-center space-y-8 max-w-4xl mx-auto transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="relative group">
            ...
            {/* Icon Circle */}
            <div className="relative w-32 h-32 md:w-40 md:h-40 mx-auto bg-gradient-to-br from-babana-cyan/20 to-babana-blue/20 dark:from-babana-navy dark:to-babana-blue/30 rounded-full flex items-center justify-center shadow-lg border border-babana-cyan/30 dark:border-babana-cyan/20 animate-float backdrop-blur-sm">
          ...
          <div className="space-y-4 max-w-2xl px-4">
             <h1 className="text-4xl md:text-5xl font-black bg-clip-text text-transparent bg-gradient-to-r from-babana-navy via-babana-blue to-babana-cyan dark:from-white dark:via-babana-cyan dark:to-babana-blue">
               {t.serverError.title}
             </h1>
          ...
          <Card className="w-full max-w-2xl relative overflow-hidden border border-babana-cyan/20 dark:border-babana-cyan/10 bg-white/80 dark:bg-card/80 backdrop-blur-lg shadow-2xl hover:shadow-babana-cyan/10 transition-all duration-300">
             <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-babana-cyan to-babana-blue" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
            ...
            <Button 
              ...
              size="lg" 
              className="gap-2 bg-gradient-to-r from-babana-blue to-babana-cyan hover:from-babana-blue/90 hover:to-babana-cyan/90 text-white shadow-lg hover:shadow-babana-cyan/25 transition-all"
            >
