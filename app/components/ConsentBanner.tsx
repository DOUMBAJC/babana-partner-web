      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 animate-in slide-in-from-bottom duration-500">
        <div className="mx-auto max-w-7xl p-4 sm:p-6">
          <div className="relative overflow-hidden rounded-2xl border border-border/50 bg-background/95 backdrop-blur-xl shadow-2xl shadow-babana-cyan/10">
            {/* Gradient décoratif */}
            <div className="absolute inset-0 bg-gradient-to-r from-babana-cyan/5 via-transparent to-babana-navy/5 pointer-events-none" />
            ...
            <div className="relative p-6 sm:p-8">
              <div className="flex flex-col gap-6">
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 rounded-xl bg-gradient-to-br from-babana-cyan/20 to-babana-navy/20 p-3">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <Button
                    onClick={acceptAll}
                    className="flex-1 h-11 bg-gradient-to-r from-babana-cyan to-babana-cyan/80 hover:from-babana-cyan/90 hover:to-babana-cyan/70 text-white font-semibold shadow-lg shadow-babana-cyan/25"
                  >
                    {content.acceptAll}
                  </Button>
