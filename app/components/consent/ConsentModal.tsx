    ...
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="rounded-lg border border-babana-cyan/20 p-5 bg-linear-to-br from-babana-cyan/5 to-babana-navy/5">
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-border">
          <Button
            onClick={handleSave}
            className="flex-1 h-11 bg-linear-to-r from-babana-cyan to-babana-cyan/80 hover:from-babana-cyan/90 hover:to-babana-cyan/70 text-white font-semibold"
          >
