...
export function getStatusConfig(
  ...
  const configs: Record<string, StatusConfig> = {
    ...
    approved: {
      ...
      className: "bg-linear-to-r from-green-500 to-emerald-600 text-white border-0",
      icon: CheckCircle,
    ...
    rejected: {
      ...
      className: "bg-linear-to-r from-red-500 to-pink-600 text-white border-0",
      icon: XCircle,
      iconColor: "text-white"
    },
    cancelled: {
      label: translations.cancelled,
      className: "bg-linear-to-r from-gray-500 to-slate-600 text-white border-0",
      icon: AlertCircle,
      iconColor: "text-white"
    },
  };
