...
export function EditDialog({ open, onOpenChange, request, action }: EditDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[95vw] sm:max-w-[700px] bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 border-0 shadow-2xl rounded-4xl sm:rounded-3xl p-0 overflow-hidden max-h-[96vh] sm:max-h-[90vh] overflow-y-auto">
