/**
 * Configuration pour l'identification de clients
 * Pays: Cameroun
 */

// Type pour les données du formulaire d'identification de client
export interface CustomerIdentifyFormData {
  firstName: string;
  lastName: string;
  idCardTypeId: string;
  idCardNumber: string;
...
export interface CustomerIdentifyFormErrors {
  firstName?: string;
  lastName?: string;
  idCardTypeId?: string;
  idCardNumber?: string;
...
export const INITIAL_FORM_DATA: CustomerIdentifyFormData = {
  firstName: '',
  lastName: '',
  idCardTypeId: '',
  idCardNumber: '',
